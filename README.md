...
![llm-iceberg2](https://github.com/user-attachments/assets/dddc568a-f362-44c3-8c63-a18f6b98dd44)
...
2. Install the required python libraries.
  ```
  pip install -U pydantic gradio httpx uvicorn accelerate fastapi torch transformers ipywidgets pandas SQLAlchemy langchain-openai langchain-community langchain langchain-core
  ```
