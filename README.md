...
2. Install the required python libraries.
  ```
  pip install -U pydantic gradio httpx uvicorn accelerate fastapi torch transformers ipywidgets pandas langchain-openai langchain-community langchain langchain-core
  ```
